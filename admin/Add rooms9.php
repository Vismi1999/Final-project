        ...
        <div class="row">
         <p class="elementToFadeInAndOut"><?php if(isset($_SESSION['msg'])) {echo $_SESSION['msg'];} ?></p>
          ...
          <!-- action="dealer_upload.php" -->
            <form  method="post" action="Add rooms.php" name="roomtype"  onsubmit="return Register()" enctype="multipart/form-data">
            <label for="room block">Room Type</label>
              <select id="room_block" name="roomtype" required>
...
$query=mysqli_query($conn,"SELECT  roomtype_id FROM `tbl_roomtype` WHERE status=1");
...
move_uploaded_file($_FILES["choose_room"]["tmp_name"],"photos1/".$choose_room);
    ...
    VALUES('$roomtype','$room_block','$room_number','$choose_room','$price','$allData','1')";
