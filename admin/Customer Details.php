            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view addrooms.php">View Add Room</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <body>
                    <tittle><center><h3>Customer Details</center></h3></tittle>
                    ...
                    <center>
                      ...
                      <tr>
                        <t>
                        <th style="width:15px";>Register ID</th>
                        <th style="width:15px";>First Name</th>
                        ...
                        <th style="width:15px">Government ID</th>
                    <t>
                </div>
                <?php
 include_once('admin_connect.php');
$result = mysqli_query($conn,"select * from registration");
        // mysqli_query($conn," SELECT cust_emailid FROM cust_login");
                    ...
                    <?php
                        while($rows=mysqli_fetch_assoc($result))
                     {
                       echo "<tr>";
                         ...
                         echo"<td>"; echo $rows['reg_id']; echo"</td>";
                         echo"<td>";echo $rows['firstname'] ; echo"</td>";
                         echo"<td>"; echo $rows['lastname']; echo"</td>";
                         echo"<td>";echo $rows['addr']; echo"</td>";
                         echo"<td>";echo $rows['phonenumber']; echo"</td>";
                       
                         echo"<td>"; echo $rows['gender']; echo"</td>";
                         echo"<td>"; echo $rows['cstate']; echo"</td>";
                         echo"<td>"; echo $rows['city']; echo"</td>";
                         echo"<td>"; echo $rows['aadharnumber']; echo"</td>";
                          echo "</tr>";
                     ?>
