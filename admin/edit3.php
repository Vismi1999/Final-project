...
$roomtype_id=$_GET['addroom_id'];
$query=mysqli_query($conn,"select * from tbl_addrooms where addroom_id='$roomtype_id'and status=1");
...
?>
           ...
           -->
            ...
            <form id="roomtype" action="edit3.php" method="POST" name="roomtype" enctype="multipart/form-data">       
            ...
            <div class="inputDiv">
             ...
             <input type="text"name="roomtype" id="roomtype"value="<?= $row['roomtype'] ?>" required> 
              ...
              <label class="inputLabel" for="cat">Room Block</label>
              <input type="text"name="number" id="number"value="<?= $row['room_block'] ?>" required> 
           
              <label class="inputLabel" for="cat">Room Number</label>
              <input type="text"name="adult" id="adult"value="<?= $row['room_number'] ?>" required>
              <label class="inputLabel" for="cat">price</label>
              <input type="text"name="children" id="children"value="<?= $row['price'] ?>" required>
              <label class="inputLabel" for="cat">multipleData</label>
              <input type="text"name="children" id="children"value="<?= $row['multipleData'] ?>" required>
            </div>
            

<input type="hidden"name="addroom_id" id="addroom_id" value="<?= $roomtype_id ?>">
