...
$query="UPDATE tbl_table SET tableseat='$tableseat',totaltable='$totaltable' where table_id='$table_id'";
...
$query=mysqli_query($conn,"select * from tbl_table where table_id='$table_id'and status=1");
...
?>
           ...
           -->
            ...
            <form id="roomtype" action="edit4.php" method="POST" name="roomtype" enctype="multipart/form-data">       
            
            <div class="inputDiv">
              <label class="inputLabel" for="cat">Enter Table Size</label>
              <input type="text"name="tableseat" id="tableseat"value="<?= $row['tableseat'] ?>" required>
           
              <label class="inputLabel" for="cat">Enter Total Seat</label>
              <input type="text"name="totaltable" id="totaltable"value="<?= $row['totaltable'] ?>" required>
