        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <body>
                    <title><center><h3>View  Details</center></h3></title>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      ...
                      <tr>
                        ...
                        <th style="width:15px";>Table Size</th>
...
?>
                    ...
                    <?php
                     ...
                     {
                        $a=$rows['delivery_id'];
                        $sq="SELECT * FROM `tbl_delivery` WHERE delivery_id='$a'";
                    ...
                    // echo"<td>".$rows['roomtype_id']."</td>";
                        ...
                        //  echo"<td>".$rows['roomtype']."</td>";
                         echo"<td>".$rows['table']."</td>";
                         echo"<td>".$rows['ordernow']."</td>";
                 ...
                 <?php
                    if($rows['status']!="1"){
                      echo '<a href="approve1.php?id='.$rows["delivery_id"].'" class="btn btn-success btn-sm">BOOKED</a>';
                    }
                    else{
