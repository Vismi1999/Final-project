...
$query = "SELECT * FROM `tbl_reception` JOIN cust_login ON tbl_reception.log_id=cust_login.log_id ";
...
?>
                    ...
                    echo "<tr>";
                         ...
                         echo"<td>".$rows['cust_emailid']."</td>";
                       
                     
                         echo"<td>".$rows['cust_pass']."</td>";
             
                  
                    
                  echo"<td><a href='edit.php?catagory_id=".$rows["rec_id"]."'><button type='button' class='btn btn-success'>EDIT</button></td>";?>      
