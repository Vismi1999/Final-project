                ...
                <div class="container-fluid">
                    ...
                    <center>
                      ...
                      <tr>
                        ...
                        <th style="width:15px";>Table</th> 
                        <th style="width:15px";>Total Table</th>
...
<?php
              ...
              while($rows=mysqli_fetch_assoc($result))
                    ...
                    echo "<tr>";
                         ...
                         echo"<td>".$rows['tableseat']."</td>";
                         echo"<td>".$rows['totaltable']."</td>";
                  ...
                  echo"<td><a href='edit4.php?table_id=".$rows["table_id"]."'><button type='button' class='btn btn-success'>EDIT</button></td>";?>      
                 ...
                 <td>
                         ...
                         if($rows['status']==0){
                           echo '<p><a href="inactivate5.php?table_id='.$rows['table_id'].'$status=0"style="color:green;font-size:17px;">unavailable</a></p>';
                         }else{
                           echo '<p><a href="activate5.php?table_id='.$rows['table_id'].'$status=1"style="color:red;font-size:17px;">Available</a></p>';
                         }
                         ?>
