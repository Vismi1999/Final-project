        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <tittle><center><h3>Food Order</center></h3></tittle>
...
$query = "select * from tbl_cashroom";
...
?>
                    ...
                    <?php
                     ...
                     {
                        $a=$rows['cash_id'];
                        $sq="SELECT * FROM `tbl_cashroom` WHERE cash_id='$a'";
                 ...
                 <?php
                    if($rows['status']!="1"){
                      echo '<a href="approve.php?id='.$rows["cash_id"].'" class="btn btn-success btn-sm">DONE</a>';
                    }
                    else{
                      echo '<small>Sucessfully Delivered</small>';
                    }
                                    ?>
