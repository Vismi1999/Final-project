...
if (isset($_POST['changepassword'])) {
 ...
 $cust_emailid=$_SESSION['sid'];
  echo"<script Type='text/javascript'>alert($encryptpwd)</script>";
  // first check the database to make sure 
  // a user does not already exist with the same username and/or email

  $user_check_query = "SELECT * FROM  cust_login WHERE cust_emailid='$cust_emailid'";
  ...
  if ($user) { // if user exists
      ...
      if ($user['cust_pass'] == $encryptpwd) {

      $query="UPDATE cust_login set password='$encryptnewpwd' where cust_emailid='$cust_emailid'";
...
<form method="POST" name="password">
  ...
  <div>
    ...
    <div class="finish"> 
    <a href="http://localhost/usedcar_showroom_management/dealer/index.php" style="margin: top 50px; margin-left: 35%;"><a href="index1.php"> Back to home</a>
