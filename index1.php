  ...
  <script type="text/javascript">
    (function(d, m){
        var kommunicateSettings = 
            {"appId":"283952697ba9a6f5154c7315fade413aa","popupWidget":true,"automaticChatOpenOnNavigation":true};
...
<a href="index1.php"><?php echo $_SESSION['username']; ?></a>

<a href="login1.php">Logout</a>
<!-- <a href="change password.php">Change Password</a> -->
<!-- <a href="profile-system/changepassword.php">Change Password</a> -->

<!-- <a href="profile_edit.php">Profile</a> -->
<a href="changepassword#.php">My Booking</a>
<a href="changepassword.php">Change Password</a>

 
  <a href="contact_index.php">Contact</a>
  <a href="about_index.php">About</a>
  <!-- <a href="../food/public_html/index.html">Foodffff</a> -->
...
<!-- </html> 
    ...
    <section class="site-hero overlay" style="background-image: url(images/img_5.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <span class="custom-caption text-uppercase text-white d-block  mb-3">Welcome To 5 <span class="fa fa-star text-primary"></span>   Hotel</span>
            <h1 class="heading">Crowne Plaza.</h1><h2 class="heading"> A Best Place To Stay</h2>
          </div>
        </div>
      </div>
     ...
     <!-- <section class="section bg-light pb-0" >
      <div class="container">
        ...
        <div class="row check-availabilty" id="next">
          <div class="block-32" data-aos="fade-up" data-aos-offset="-100">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            ...
            <p><a href="about_index.php" class="btn btn-primary text-white py-2 mr-3">Learn More</a> <span class="mr-3 font-family-serif"><em>or</em></span> <a href="https://vimeo.com/channels/staffpicks/93951774"  data-fancybox class="text-uppercase letter-spacing-1">See video</a></p>
          </div>
