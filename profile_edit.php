...
<?php
    ...
    include 'connect1.php';
     ...
     $id= $_SESSION['sid'];
    $user_res= mysqli_query($conn,"SELECT * from registration WHERE reg_id=$id");
...
if (isset($_POST["edit"])) {
    ...
    $addr=$_POST['aadharnumber'];
    $gender=$_POST['gender'];
    $state=$_POST['cstate'];
    $city=$_POST['city'];
    $sql="UPDATE registration SET firstname='$fname',lastname='$lname',addr='$addr',phonenumber='$mobile',gender='$gender',cstate='$cstate',city=$city WHERE reg_id=10000";
                ...
                <div class="container">
                    <div class="signup-content">
                     ...
                     <h2 class="form-title">Create account</h2>
                        ...
                        <div class="form-group">
                          <input type="text" class="form-input" name="aadharnumber"autocomplete="off"  placeholder="Aadhar Number" required/>
                      </div>
...
<!--                      
                            <div class="form-group">
                                <input type="text" class="form-input" name="email" autocomplete="off" placeholder="Your Email" required onblur="return emailValidate ()"/>
                            </div>
