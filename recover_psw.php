...
// }
    ...
    if(isset($_POST["recover"])){
        ...
        //  $conn=new DatabaseCon();
        $email = $_POST["email"];

        $sql = "SELECT * FROM cust_login WHERE cust_emailid='$email'";
       ...
       //$query = mysqli_num_rows($sql);
        ...
        if(mysqli_num_rows($rs) <= 0){
           ...
           <?php
            ...
            $token_sql= "UPDATE cust_login SET reset_code='$token' WHERE cust_emailid='$email'";
            //session_start ();
            ...
            if(mysqli_query($conn, $token_sql)){
                ...
                http://localhost/PROJECT/Hotel-System1/reset_psw.php?username=$email&token=$token
                <br><br>
                <p>With regrads,</p>
                <b>Crowne Plaza  </b>";
